...
export default function AddProductFormMulti({
  onAddProducts,
}: AddProductFormMultiProps) {
  const [products, setProducts] = useState<Product[]>([
    { name: '', color: '', model: '', brand: '', price: 0 },
  ])
      ...
      {products.map((product, index) => (
        <div key={index} className="flex mb-2">
          ...
          <button
            ...
            className="bg-red-500 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded"
          >
            Remove
          </button>
        </div>
